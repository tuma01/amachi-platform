-- ============================================================
-- Script: V10_10__create_med_audit_tables.sql
...
CREATE TABLE IF NOT EXISTS MED_PATIENT_AUD (
    ...
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_MED_PATIENT_AUD_REV FOREIGN KEY (REV) REFERENCES DMN_AUDIT_REVISION(REV)
...
CREATE TABLE IF NOT EXISTS MED_DOCTOR_AUD (
    ...
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_MED_DOCTOR_AUD_REV FOREIGN KEY (REV) REFERENCES DMN_AUDIT_REVISION(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS MED_EPISODE_OF_CARE_AUD (
    ...
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_MED_EPISODE_OF_CARE_AUD_REV FOREIGN KEY (REV) REFERENCES DMN_AUDIT_REVISION(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS MED_ENCOUNTER_AUD (
    ...
    FK_ID_HISTORY           BIGINT,

    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_MED_ENCOUNTER_AUD_REV FOREIGN KEY (REV) REFERENCES DMN_AUDIT_REVISION(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS MED_CONDITION_AUD (
    ...
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_MED_CONDITION_AUD_REV FOREIGN KEY (REV) REFERENCES DMN_AUDIT_REVISION(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS MED_OBSERVATION_AUD (
    ...
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_MED_OBSERVATION_AUD_REV FOREIGN KEY (REV) REFERENCES DMN_AUDIT_REVISION(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS MED_PRESCRIPTION_AUD (
    ...
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_MED_PRESCRIPTION_AUD_REV FOREIGN KEY (REV) REFERENCES DMN_AUDIT_REVISION(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS MED_APPOINTMENT_AUD (
    ...
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_MED_APPOINTMENT_AUD_REV FOREIGN KEY (REV) REFERENCES DMN_AUDIT_REVISION(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
