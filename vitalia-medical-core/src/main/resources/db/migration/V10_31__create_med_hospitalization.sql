...
CREATE TABLE IF NOT EXISTS MED_HOSPITALIZATION (
    ...
    FK_ID_ROOM                  BIGINT,
    FK_ID_BED                   BIGINT,
    FK_ID_INSURANCE             BIGINT NULL COMMENT 'Seguro del paciente que cubre esta hospitalización (nullable — puede no tener seguro)',
    ...
    CONSTRAINT FK_MED_HOSP_INSURANCE  FOREIGN KEY (FK_ID_INSURANCE)   REFERENCES MED_INSURANCE(ID),
    ...
    INDEX IDX_HOSP_INSURANCE (FK_ID_INSURANCE)
