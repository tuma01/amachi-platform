...
CREATE TABLE IF NOT EXISTS MED_APPOINTMENT_REMINDER_AUD (
    ...
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_APPT_REMINDER_AUD_REV FOREIGN KEY (REV) REFERENCES REVINFO(REV)
...
CREATE TABLE IF NOT EXISTS MED_DOCTOR_HOSPITAL_ASSIGN_AUD (
    ...
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_DHA_AUD_REV FOREIGN KEY (REV) REFERENCES REVINFO(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS MED_MEDICAL_HISTORY_AUD (
    ...
    NOTES                   TEXT,
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_MED_HIST_AUD_REV FOREIGN KEY (REV) REFERENCES REVINFO(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS MED_ACTUAL_ILLNESS_AUD (
    ...
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_ACT_ILL_AUD_REV FOREIGN KEY (REV) REFERENCES REVINFO(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS MED_PAST_ILLNESS_AUD (
    ...
    TREATMENTS              VARCHAR(500),
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_PAST_ILL_AUD_REV FOREIGN KEY (REV) REFERENCES REVINFO(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS MED_FAMILY_HISTORY_AUD (
    ...
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_FAM_HIST_AUD_REV FOREIGN KEY (REV) REFERENCES REVINFO(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS MED_HEREDITARY_DISEASE_AUD (
    ...
    DIAGNOSIS_DATE          DATE,
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_HER_DIS_AUD_REV FOREIGN KEY (REV) REFERENCES REVINFO(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS MED_INSURANCE_AUD (
    ...
    IS_CURRENT              TINYINT(1),
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_INSURANCE_AUD_REV FOREIGN KEY (REV) REFERENCES REVINFO(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS MED_PHYSIOLOGICAL_HABIT_AUD (
    ...
    OTHERS                  VARCHAR(500),
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_PHYS_HAB_AUD_REV FOREIGN KEY (REV) REFERENCES REVINFO(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS MED_TOXIC_HABIT_AUD (
    ...
    OTHERS                  VARCHAR(500),
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_TOX_HAB_AUD_REV FOREIGN KEY (REV) REFERENCES REVINFO(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS MED_HOSPITALIZATION_AUD (
    ...
    CURRENCY                    VARCHAR(10),
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_HOSP_AUD_REV FOREIGN KEY (REV) REFERENCES REVINFO(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS MED_DISCHARGE_MEDICATION_AUD (
    ...
    INSTRUCTIONS            TEXT,
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_DIS_MED_AUD_REV FOREIGN KEY (REV) REFERENCES REVINFO(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS MED_CONSULTATION_AUD (
    ...
    NOTES                       TEXT,
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_CONS_AUD_REV FOREIGN KEY (REV) REFERENCES REVINFO(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS MED_ORGANIZATION_AUD (
    ...
    IS_ACTIVE               TINYINT(1),
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_ORG_AUD_REV FOREIGN KEY (REV) REFERENCES REVINFO(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS MED_NURSE_PROF_SPECIALITY_AUD (
    ...
    DESCRIPTION             VARCHAR(500),
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_NURSE_SPEC_AUD_REV FOREIGN KEY (REV) REFERENCES REVINFO(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS MED_USER_EDUCATION_AUD (
    ...
    END_DATE                DATE,
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_EDU_AUD_REV FOREIGN KEY (REV) REFERENCES REVINFO(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS MED_USER_EXPERIENCE_AUD (
    ...
    DESCRIPTION             VARCHAR(500),
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_EXP_AUD_REV FOREIGN KEY (REV) REFERENCES REVINFO(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS MED_USER_COURSE_AUD (
    ...
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_COURSE_AUD_REV FOREIGN KEY (REV) REFERENCES REVINFO(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS MED_USER_CONFERENCE_AUD (
    ...
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_CONF_AUD_REV FOREIGN KEY (REV) REFERENCES REVINFO(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
