package com.amachi.app.vitalia.medicalcore.habit.service;
...
public interface ToxicHabitService extends GenericService<ToxicHabit, ToxicHabitDto, HabitSearchDto> {
}
