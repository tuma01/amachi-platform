...
@Tag(name = "Medical Consultation Type", description = "REST API para gestionar el catálogo de tipos de consulta médica.")
public interface MedicalConsultationTypeApi extends GenericApi<MedicalConsultationTypeDto> {
        String NAME_API = "Medical Consultation Type";
        ...
        ResponseEntity<MedicalConsultationTypeDto> getConsultationTypeById(
        ...
        ResponseEntity<MedicalConsultationTypeDto> createConsultationType(
                        @Parameter(description = "Detalles del " + NAME_API
                                        + " a crear.", required = true) @Valid @RequestBody @NonNull MedicalConsultationTypeDto dto);
        ...
        ResponseEntity<MedicalConsultationTypeDto> updateConsultationType(
                        @Parameter(description = "ID del " + NAME_API
                                        + " a actualizar.", required = true) @PathVariable("id") @NonNull Long id,
                        @Parameter(description = "Nuevos detalles del " + NAME_API
                                        + ".", required = true) @Valid @RequestBody @NonNull MedicalConsultationTypeDto dto);
        ...
        ResponseEntity<Void> deleteConsultationType(
                        @Parameter(description = "ID del " + NAME_API
        ...
        ResponseEntity<List<MedicalConsultationTypeDto>> getAllConsultationTypes();
        ...
        ResponseEntity<PageResponseDto<MedicalConsultationTypeDto>> getPaginatedConsultationTypes(
                        @NonNull MedicalConsultationTypeSearchDto searchDto,
