...
CREATE TABLE IF NOT EXISTS DMN_TENANT_AUD (
    ...
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_DMN_TENANT_AUD_REV FOREIGN KEY (REV) REFERENCES DMN_AUDIT_REVISION(REV)
...
CREATE TABLE IF NOT EXISTS DMN_PERSON_TENANT_AUD (
    ...
    PRIMARY KEY (ID, REV),
    CONSTRAINT FK_DMN_PERSON_TENANT_AUD_REV FOREIGN KEY (REV) REFERENCES DMN_AUDIT_REVISION(REV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
